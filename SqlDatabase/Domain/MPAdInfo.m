...
//    }
    ...
    [ads addObject:[MPAdInfo infoWithTitle:@"Google AdMob" ID:@"e251c5ae02514e2bb2eb83f938435c34" type:MPAdInfoBanner]];
...
+ (NSArray *)interstitialAds
{
    ...
    // 3rd Party Networks
             ...
             [MPAdInfo infoWithTitle:@"Vungle" ID:@"5871797d4004456eb6be0d0299de80c5" type:MPAdInfoInterstitial],
    #endif
             ];
}
...
+ (NSArray *)rewardedVideoAds
{
    ...
    // 3rd Party Networks
             ...
             [MPAdInfo infoWithTitle:@"Vungle" ID:@"06f61404cf0046b8a3ca0802946818a0" type:MPAdInfoRewardedVideo],
    #endif
             ];
}
...
+ (NSArray *)nativeAds
{
    ...
    // 3rd Party Networks
             ...
             [MPAdInfo infoWithTitle:@"Flurry Native Ad" ID:@"92adb42df02445f6af7383cb162e29c1" type:MPAdInfoNative],
